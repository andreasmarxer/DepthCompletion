...
if xs1-bb_width>1 && ys1-bb_width>1 && xs2+bb_width<size(depth_img,2) && ys2-bb_width>1 ...
    && xs3+bb_width<size(depth_img,2) && ys3+bb_width<size(depth_img,1)...
    && xs4-bb_width>1 && ys4+bb_width<size(depth_img,1)
    ...
    points_y_12 = ones(xs2-xs1,1) * -1 * bb_width_scale + repmat((y_top(xs1-bb_width_half:xs2-bb_width_half-1))',1,bb_width);
    points_y_12 = points_y_12(:);
    points_x_23 = ones(ys3-ys2,1) * 1 * bb_width_scale + repmat((x_right(ys2-bb_width_half:ys3-bb_width_half-1))',1,bb_width);
    points_x_23 = points_x_23(:);
    points_y_34 = ones(xs3-xs4,1) * 1 * bb_width_scale + repmat((y_bot(xs3+bb_width_half:-1:xs4+bb_width_half+1))',1,bb_width);
    points_y_34 = points_y_34(:);
    points_x_41 = ones(ys4-ys1,1) * -1 * bb_width_scale + repmat((x_left(ys4+bb_width_half:-1:ys1+bb_width_half+1))',1,bb_width);
    ...
    points_y_12 = ones(xs2-xs1,1) * -1 * bb_width_scale + repmat((y_top(xs1:xs2-1))',1,bb_width);
    points_y_12 = points_y_12(:);
    points_y_34 = ones(xs3-xs4,1) * 1 * bb_width_scale + repmat((y_bot(xs3:-1:xs4+1))',1,bb_width);
    points_y_34 = points_y_34(:);
    % rest is equal
    points_y_23 = repmat((ys2:ys3-1)', bb_width, 1);
    points_y_41 = repmat((ys4:-1:ys1+1)', bb_width, 1);

    points_x_23 = ones(ys3-ys2,1) * 1 * bb_width_scale + repmat((x_right(ys2:ys3-1))',1,bb_width);
    points_x_23 = points_x_23(:);
    points_x_41 = ones(ys4-ys1,1) * -1 * bb_width_scale + repmat((x_left(ys4:-1:ys1+1))',1,bb_width);
    points_x_41 = points_x_41(:);
end
