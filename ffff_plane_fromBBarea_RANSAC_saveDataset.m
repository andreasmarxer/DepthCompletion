...
for label = label_array
    ...
    if ismember(label, asl_train_labels)
        ...
        for window = 1:size(left_x_vec)
            ...
            %% RANSAC
            % if more depth measurments than depth_th (%) in bb frame
            ...
            for ransac_it = 1:500
                ...
                %% while loop ---------------------------------------------
                while opt_ransac_crit_xy_minmax || opt_ransac_crit_area ...
                        || opt_ransac_crit_depth
                    ...
                    opt_ransac_crit_xy_minmax = max(points_x(random3))-...
                        min(points_x(random3)) < (x2-x1)/min_max_th || ...
                        max(points_y(random3))-min(points_y(random3)) ...
                        < (y4-y1)/min_max_th;
                    ...
                    if depth_method == 2
                        ...
                        opt_ransac_crit_depth = max(points_z(random3))-...
                            min(points_z(random3)) > depth_dist_th;
                    end
